           ...
           <h1 className='text-center text-primary fw-bolder fs-1'>Available Jobs</h1>
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td>{data.jobplace}</td>
                      <td className='d-flex'>
                        <button onClick={()=>{handleshow(data.jobtitle,data.Cname)}}  className='btn btn-success me-2 ms-2'><i class="fa-solid fa-pen-nib me-1"></i>Apply</button>
                      </td>
                    </tr>)):
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group className="mb-1 d-flex" controlId="exampleForm.ControlInput1">
                                ...
                                <Form.Control onChange={(e)=>{setapply({...apply,cname:e.target.value})}} type="text" placeholder="Candidate's Name" />
                            </Form.Group>

                            <Form.Group className="mb-1 d-flex" controlId="exampleForm.ControlInput1">
                                <Form.Label></Form.Label>
                                <Form.Control onChange={(e)=>{setapply({...apply,cno:e.target.value})}} type="number" placeholder="Phone Number" />
                            </Form.Group>

                            <Form.Group className="mb-1 d-flex" controlId="exampleForm.ControlInput1">
                                <Form.Label></Form.Label>
                                <Form.Control onChange={(e)=>{setapply({...apply,cemail:e.target.value})}} type="email" placeholder="E-mail" />
                            </Form.Group>
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={handleupdate} variant="primary">Apply</Button>
                    </Modal.Footer>
                </Modal>
